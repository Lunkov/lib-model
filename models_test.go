...
func TestCheckModelsGetList(t *testing.T) {
  ...
  res, count, ok := DBTableGet(TEST_MODEL+"org111", nil, []string{"name", "url_logo"}, []string{"name desc"}, 0, 10)
  ...
  res, count, ok = DBTableGet(TEST_MODEL, nil, []string{"name", "url_logo"}, []string{"name asc", "url_logo asc"}, 0, 10)
  ...
  res, count, ok = DBTableGet(TEST_MODEL, nil, []string{}, []string{}, 0, 0)
  ...
  resn = ""
  res, ok = DBGetItemByCODE(TEST_MODEL, nil, "test.1.org.1111")
  assert.Equal(t, false, ok)
  assert.Equal(t, resn, string(res))
  ...
  res, ok = DBGetItemByCODE(TEST_MODEL, nil, "test.1.org")
  assert.Equal(t, true, ok)
  assert.Equal(t, resn, string(res))

  resn = ""
  res, ok = DBGetItemByID(TEST_MODEL, nil, "00000002-0003-0004-0005-000000004")
  assert.Equal(t, false, ok)
  assert.Equal(t, resn, string(res))

  resn = "{\"address_legal.city\":\"Moscow\",\"address_legal.country\":\"Russia\",\"address_legal.index\":\"127282\",\"bank.0.account\":\"111111134583459834573279\",\"bank.0.bik\":\"1111111\",\"bank.1.account\":\"2111111134583459834573279\",\"bank.1.bik\":\"21111111\",\"code\":\"test.1.org\",\"id\":\"00000002-0003-0004-0005-000000000004\",\"name\":\"Test NEW ORG\"}"
  res, ok = DBGetItemByID(TEST_MODEL, nil, "00000002-0003-0004-0005-000000000004")
  assert.Equal(t, true, ok)
  assert.Equal(t, resn, string(res))


  ok = DBUpdate(TEST_MODEL, nil, &map[string]interface{}{"id": "00000002-0003-0004-0005-000000000004", "code": "test.1.org", "name": "Test NEW ORG UPDATE"})
  assert.Equal(t, true, ok)
  ...
  res, count, ok = DBTableGet(TEST_MODEL, nil, []string{"name", "bank"}, []string{"name asc"}, 0, 10)
  ...
  res, count, ok = DBTableGet(TEST_MODEL, nil, []string{}, []string{"name asc"}, 0, 10)
  
  assert.Equal(t, true, ok)
  assert.Equal(t, 7, count)

  /// DELETE
  ok = DBDeleteItemByID(TEST_MODEL, nil, "00000002-0003-0004-0005-000000000004")
  assert.Equal(t, true, ok)
  ...
  res, count, ok = DBTableGet(TEST_MODEL, nil, []string{"name"}, []string{"name asc"}, 0, 10)
...
func TestCheckModelsGetListComplexUpdate(t *testing.T) {
  ...
  res, count, ok := DBTableGet(TEST_MODEL + "org111", &userUser, []string{"name", "url_logo"}, []string{"name desc"}, 0, 10)
  
  assert.Equal(t, true, ok)
  assert.Equal(t, 0, count)
  assert.Equal(t, "", string(res))

  res, count, ok = DBTableGet(TEST_MODEL, &userUser, []string{"name", "url_logo"}, []string{"name asc", "url_logo asc"}, 0, 10)
  ...
  res, count, ok = DBTableGet(TEST_MODEL, &userUser, []string{}, []string{}, 0, 0)
  ...
  // uid4, _ := uuid.Parse("00000002-0003-0004-0005-000000000004")
  ok = DBInsert(TEST_MODEL, &userUser, &map[string]interface{}{"id": "00000002-0003-0004-0005-000000000004", "code": "test.1.org", "name": "Test NEW ORG", "address_legal.city":"Moscow", "address_legal.country":"Russia", "address_legal.index":"127282", "bank.0.account":"111111134583459834573279", "bank.0.bik":"1111111", "bank.1.account":"2111111134583459834573279", "bank.1.bik":"21111111"})
  ...
  resn = ""
  res, ok = DBGetItemByCODE(TEST_MODEL, &userUser, "test.1.org.1111")
  assert.Equal(t, false, ok)
  assert.Equal(t, resn, string(res))

  resn = "{\"address_legal.city\":\"Moscow\",\"address_legal.country\":\"Russia\",\"address_legal.index\":\"127282\",\"bank.0.account\":\"111111134583459834573279\",\"bank.0.bik\":\"1111111\",\"bank.1.account\":\"2111111134583459834573279\",\"bank.1.bik\":\"21111111\",\"code\":\"test.1.org\",\"id\":\"00000002-0003-0004-0005-000000000004\",\"name\":\"Test NEW ORG\"}"
  res, ok = DBGetItemByCODE(TEST_MODEL, &userUser, "test.1.org")
  assert.Equal(t, true, ok)
  assert.Equal(t, resn, string(res))

  resn = ""
  res, ok = DBGetItemByID(TEST_MODEL, &userUser, "00000002-0003-0004-0005-000000004")
  assert.Equal(t, false, ok)
  assert.Equal(t, resn, string(res))

  resn = "{\"address_legal.city\":\"Moscow\",\"address_legal.country\":\"Russia\",\"address_legal.index\":\"127282\",\"bank.0.account\":\"111111134583459834573279\",\"bank.0.bik\":\"1111111\",\"bank.1.account\":\"2111111134583459834573279\",\"bank.1.bik\":\"21111111\",\"code\":\"test.1.org\",\"id\":\"00000002-0003-0004-0005-000000000004\",\"name\":\"Test NEW ORG\"}"
  res, ok = DBGetItemByID(TEST_MODEL, &userUser, "00000002-0003-0004-0005-000000000004")
  assert.Equal(t, true, ok)
  assert.Equal(t, resn, string(res))


  ok = DBUpdate(TEST_MODEL, &userUser, &map[string]interface{}{"id": "00000002-0003-0004-0005-000000000004", "code": "test.1.org", "name": "Test NEW ORG UPDATE"})
  assert.Equal(t, true, ok)
  ...
  ok = DBUpdate(TEST_MODEL, &userUser, &map[string]interface{}{"id": "00000002-0003-0004-0005-000000000004", "code": "test.1.org", "name": "Test NEW ORG UPDATE", "address_legal.city":"Moscow", "address_legal.country":"Russia", "address_legal.index":"127282", "bank.0.account":"111111134583459834573279", "bank.0.bik":"1111111", "bank.1.account":"2111111134583459834573279", "bank.1.bik":"21111111"})
  assert.Equal(t, true, ok)
  ...
  res, count, ok = DBTableGet(TEST_MODEL, &userUser, []string{"name", "bank"}, []string{"name asc"}, 0, 10)
  ...
  res, count, ok = DBTableGet(TEST_MODEL, &userUser, []string{}, []string{"name asc"}, 0, 10)
  
  assert.Equal(t, true, ok)
  assert.Equal(t, 7, count)

  /// DELETE
  ok = DBDeleteItemByID(TEST_MODEL, &userOther, "00000002-0003-0004-0005-000000000004")
  assert.Equal(t, false, ok)

  ok = DBDeleteItemByID(TEST_MODEL, &userUser, "00000002-0003-0004-0005-000000000004")
  assert.Equal(t, false, ok)

  ok = DBDeleteItemByID(TEST_MODEL, &userAdmin, "00000002-0003-0004-0005-000000000004")
  assert.Equal(t, true, ok)

  resn = ""
  res, ok = DBGetItemByID(TEST_MODEL, &userAdmin, "00000002-0003-0004-0005-000000000004")
  assert.Equal(t, false, ok)
  assert.Equal(t, resn, string(res))


  res, count, ok = DBTableGet(TEST_MODEL, &userAdmin, []string{"name"}, []string{"name asc"}, 0, 10)
...
func TestCheckModelsOwner(t *testing.T) {
  ...
  res, count, ok = DBTableGet(TEST_MODEL, &userUser, []string{"name", "description"}, []string{"name asc"}, 0, 10)
  ...
  // uid4, _ := uuid.Parse("00000002-0003-0004-0005-000000000004")
  ok = DBInsert(TEST_MODEL, &userUser, &map[string]interface{}{"id": "00000012-0003-0004-0005-000000000004", "code": "test.1.project", "name": "Test NEW PROJECT"})
  assert.Equal(t, true, ok)

  ok = DBInsert(TEST_MODEL, &userUser, &map[string]interface{}{"id": "00000012-0003-0004-0005-000000000004", "code": "test.1.project", "name": "Test NEW PROJECT TWO"})
  assert.Equal(t, false, ok)

  ok = DBInsert(TEST_MODEL, &userAdmin, &map[string]interface{}{"id": "00000011-0003-0004-0005-000000000004", "code": "test.admin.project", "name": "Test NEW PROJECT ADMIN"})
  assert.Equal(t, false, ok)

  ok = DBInsert(TEST_MODEL, &userOther, &map[string]interface{}{"id": "00000011-0003-0004-0005-000000000014", "code": "test.other.project", "name": "Test NEW PROJECT OTHER"})
  assert.Equal(t, false, ok)

  resn = ""
  res, ok = DBGetItemByCODE(TEST_MODEL, &userUser, "test.1.project.1111")
  assert.Equal(t, false, ok)
  assert.Equal(t, resn, string(res))
  ...
  res, ok = DBGetItemByCODE(TEST_MODEL, &userUser, "test.1.project")
  assert.Equal(t, true, ok)
  assert.Equal(t, resn, string(res))

  resn = ""
  res, ok = DBGetItemByCODE(TEST_MODEL, &userAdmin, "test.1.project")
  assert.Equal(t, false, ok)
  assert.Equal(t, resn, string(res))

  resn = "{\"code\":\"test.1.project\",\"id\":\"00000012-0003-0004-0005-000000000004\",\"name\":\"Test NEW PROJECT\",\"owner.email\":\"user@\",\"owner.id\":\"00000012-0003-0004-0005-000000000003\"}"
  res, ok = DBGetItemByID(TEST_MODEL, &userUser, "00000012-0003-0004-0005-000000000004")
  assert.Equal(t, true, ok)
  assert.Equal(t, resn, string(res))
  ...
  res, ok = DBGetItemByID(TEST_MODEL, &userAdmin, "00000012-0003-0004-0005-000000000004")
  assert.Equal(t, false, ok)
  assert.Equal(t, resn, string(res))

  res, ok = DBGetItemByID(TEST_MODEL, &userOther, "00000012-0003-0004-0005-000000000004")
  assert.Equal(t, false, ok)
  assert.Equal(t, resn, string(res))

  ok = DBUpdate(TEST_MODEL, &userUser, &map[string]interface{}{"id": "00000012-0003-0004-0005-000000000004", "name": "Test PROJECT UPDATE"})
  assert.Equal(t, true, ok)
  ...
  ok = DBUpdate(TEST_MODEL, &userUser, &map[string]interface{}{"id": "00000012-0003-0004-0005-000000000004", "work_groups.0.id": "00000012-0003-0004-0005-000000010104", "work_groups.0.name": "admin"})
  assert.Equal(t, true, ok)
...
return
  ...
  res, count, ok = DBTableGet(TEST_MODEL, &userUser, []string{"name"}, []string{"name asc"}, 0, 10)
  assert.Equal(t, true, ok)
